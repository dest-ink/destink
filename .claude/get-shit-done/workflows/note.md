...
- **Global scope**: `/Users/dknell/Projects/destink/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/dknell/Projects/destink/.claude/notes/`)
...
2. Glob `/Users/dknell/Projects/destink/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/dknell/Projects/destink/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/dknell/Projects/destink/.claude/notes/` — works in any directory
