# Requirements Archive: v1.2 Content Pipeline Automation
...
- [x] **AUTO-02**: User can toggle auto-draft generation on/off per automation schedule
- [x] **AUTO-03**: User can set max drafts per scheduled run in the automation config
- [x] **AUTO-04**: Scheduled research runs execute automatically via cron/worker and generate drafts when enabled
- [x] **AUTO-05**: Automation config is separate from research source config (own settings section/page)
...
| AUTO-01 | Phase 14 | Done |
| AUTO-02 | Phase 14 | Done |
| AUTO-03 | Phase 14 | Done |
| AUTO-05 | Phase 14 | Done |
| AUTO-04 | Phase 15 | Done |

**Coverage:**
- v1.1 requirements: 15 total, 15 completed
- v1.2 requirements: 14 total, 14 completed
