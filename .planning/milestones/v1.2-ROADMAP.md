...
- ✅ **v1.2 Content Pipeline Automation** — Phases 12-15 (shipped 2026-03-30)
...
### v1.2 Content Pipeline Automation (Complete)
...
- [x] **Phase 14: Automation Config** - Schema and UI for scheduling research runs with auto-draft toggle
- [x] **Phase 15: Automation Worker** - Cron worker that executes scheduled research runs and generates drafts
...
Plans:
- [x] 13.1-01-PLAN.md — Add router.refresh() to ResearchRunPanel finally block
...
Plans:
- [x] 14-01-PLAN.md — Schema table + cron-utils module + unit tests
- [x] 14-02-PLAN.md — Schedule CRUD API, automation page UI, schedule cards/form, nav link
...
Plans:
- [x] 15-01: Daemon scheduler integration + runDueAutomations worker
...
| 14. Automation Config | v1.2 | 2/2 | Complete | 2026-03-30 |
| 15. Automation Worker | v1.2 | 1/1 | Complete | 2026-03-30 |
